				...
				<main id="content">
					...
					<section id="bio">
						...
						<main class="justified">
							<p><span id="am_i_still_alive" data-start="<?php echo $born; ?>"><?php echo number_format($alive); ?></span> seconds and counting. Born and raised in <a target="_blank" href="https://en.wikipedia.org/wiki/Santiago_de_los_Caballeros">Santiago de los 30 Caballeros</a> and now moving about NYC, here is a brief description of the time in between.</p>
							<h2>Early Years</h2>
							<article>
